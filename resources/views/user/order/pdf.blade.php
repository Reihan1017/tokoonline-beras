...
<div class="invoice-description">
  <div class="invoice-left-top float-left">
    ...
    <div class="address">
      <p><strong>Wilayah: </strong>{{$order->country}}</p>
      <p><strong>Alamat: </strong>{{ $order->address1 }} ATAU {{ $order->address2}}</p>
  ...
  <table class="table table-bordered table-stripe">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <th><span>Rp{{number_format($order->total_amount,2, ',', '.')}}</span></th>
      </tr>
    </tfoot>
  </table>
</section>
