      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          ...
          <select name="child_cat_id" id="child_cat_id" class="form-control">
              ...
              {{-- Opsi subkategori akan dimuat melalui JS --}}
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
              ...
              @foreach($items as $item)
                ...
                @endphp
                <option value="S" @if(in_array("S",$data)) selected @endif>5kg</option>
                <option value="M" @if(in_array("M",$data)) selected @endif>10kg</option>
                <option value="L" @if(in_array("L",$data)) selected @endif>25kg</option>
                <option value="XL" @if(in_array("XL",$data)) selected @endif>50kg</option>
              @endforeach
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Terlaris</option>
          </select>
        </div>
