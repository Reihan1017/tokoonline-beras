                            ...
                            <div class="price-filter">
                                <div class="price-filter-inner">
                                    ...
                                    <div class="product_filter">
                                        <button type="submit" class="filter_button">Terapkan Filter</button>
    ...
    @foreach($recent_products as $product)
        ...
        <div class="single-post first">
            ...
            <div class="content">
                ...
                @endphp
                <p class="price">
                    <del class="text-muted">Rp{{number_format($product->price,2)}}</del>
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                @if($product->discount)
                                                    <span class="price-dec">{{$product->discount}} % Diskon</span>
                                                @endif
                                            </a>
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#{{$product->id}}" title="Lihat Cepat" href="#"><i class="ti-eye"></i><span>Lihat Cepat</span></a>
                                                    <a title="Favorit" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class="ti-heart"></i><span>Tambah ke Favorit</span></a>
                                                </div>
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        ...
                                        <div class="quickview-stock">
                                            @if($product->stock >0)
                                                <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} tersedia</span>
                                            @else
