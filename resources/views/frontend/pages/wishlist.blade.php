							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Tambah ke Keranjang</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Tidak ada wishlist yang tersedia. <a href="{{route('product-grids')}}" style="color:blue;">Lanjut Belanja</a>
									</td>
								</tr>
							@endif
						</tbody>
