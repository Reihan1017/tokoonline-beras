			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-12">
					<div class="shop-sidebar">
						...
						<!--/ Akhir Widget Kategori -->

						<!-- Widget Berdasarkan Harga -->
						<div class="single-widget range">
							<h3 class="title">Cari berdasarkan Harga</h3>
						...
						<!--/ Akhir Widget Berdasarkan Harga -->
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Tambah ke Favorit" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class="ti-heart"></i><span>Favorit</span></a>
																</div>
									...
									@endforeach
								@else
									<h4 class="text-warning" style="margin:100px auto;">Tidak ada produk yang tersedia.</h4>
								@endif							
							</div>
							 <div class="row">
