                            ...
                            <div class="col-12">
                                ...
                                <div class="comment-review">
                                    <div class="add-review">
                                        ...
                                        <p>Alamat email Anda tidak akan dipublikasikan. Kolom wajib diisi ditandai</p>
                                    </div>
                                    ...
                                    <div class="review-inner">
                                                    ...
                                                    <div class="rating_box">
                                                        <div class="star-rating">
                                                            <div class="star-rating__wrap">
                                                                ...
                                                                <label class="star-rating__ico fa fa-star-o" for="star-rating-5" title="5 dari 5 bintang"></label>
                                                                <input class="star-rating__input" id="star-rating-4" type="radio" name="rate" value="4">
                                                                <label class="star-rating__ico fa fa-star-o" for="star-rating-4" title="4 dari 5 bintang"></label>
                                                                <input class="star-rating__input" id="star-rating-3" type="radio" name="rate" value="3">
                                                                <label class="star-rating__ico fa fa-star-o" for="star-rating-3" title="3 dari 5 bintang"></label>
                                                                <input class="star-rating__input" id="star-rating-2" type="radio" name="rate" value="2">
                                                                <label class="star-rating__ico fa fa-star-o" for="star-rating-2" title="2 dari 5 bintang"></label>
                                                                <input class="star-rating__input" id="star-rating-1" type="radio" name="rate" value="1">
                                                                <label class="star-rating__ico fa fa-star-o" for="star-rating-1" title="1 dari 5 bintang"></label>
                                                                @error('rate')
                                        ...
                                        <p class="text-center p-5">
                                            Anda harus <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Masuk</a> atau <a style="color:blue" href="{{route('register.form')}}">Daftar</a>
                                        </p>
                                        @endauth
                                    </div>
                                </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#modelExample" title="Lihat Cepat" href="#"><i class="ti-eye"></i><span>Lihat Cepat</span></a>
                                            <a title="Favorit" href="#"><i class="ti-heart"></i><span>Tambah ke Favorit</span></a>
                                            <a title="Bandingkan" href="#"><i class="ti-bar-chart-alt"></i><span>Tambah ke Perbandingan</span></a>
                                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Tutup"><span class="ti-close" aria-hidden="true"></span></button>
            </div>
