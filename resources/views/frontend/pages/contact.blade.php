				...
				<div class="col-lg-8 col-12">
					<div class="form-main">
						<div class="title">
							...
							@endphp
							<h4>Hubungi Kami</h4>
							<h3>Tulis pesan kepada kami 
								@auth 
								@else
									<span style="font-size:12px;" class="text-danger">[Anda harus login terlebih dahulu]</span>
								@endauth
							</h3>
						</div>
							...
							<div class="row">
								...
								<div class="col-12">
									<div class="form-group message">
										...
										<textarea name="message" id="message" cols="30" rows="9" placeholder="Tulis pesan Anda di sini"></textarea>
									</div>
								</div>
								<div class="col-12">
...
<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		...
		<div class="modal-body">
			<p class="text-warning">Terjadi kesalahan saat mengirim pesan.</p>
		</div>
	  </div>
	</div>
</div>
