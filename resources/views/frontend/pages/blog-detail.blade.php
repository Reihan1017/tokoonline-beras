                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Halaman Artikel Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Komen ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        <label>Pesan Kamu<span>*</span></label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Kirim Komen</span><span class="comment_btn reply" style="display: none;">Jawab Komen</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Kamu Perlu <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> atau <a style="color:blue" href="{{route('register.form')}}">Register</a> for comment.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Komen ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Postingan Baru-baru ini</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Daftar & dapatkan berita <br> serta update terbaru.</h4>
