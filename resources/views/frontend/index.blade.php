                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Belanja Sekarang</span></a>
                                                <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Wishlist</span></a>
                                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                                ...
                                <h3>{{$data->title}} <br>Diskon hingga<span> {{$data->discount}}%</span></h3>
                                <a href="{{route('product-detail',$data->slug)}}">Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
                    <!-- /End Single Banner  -->
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                <a href="{{route('product-detail',$product->slug)}}">
                                    ...
                                    <img class="default-img" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                    <img class="hover-img" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                    {{-- <span class="out-of-stock">Terbaik</span> --}}
                                </a>
                                <div class="button-head">
                                    <div class="product-action">
                                        <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Belanja Sekarang</span></a>
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Masukan ke Keranjang</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
